...
class PasswordService {
    func getToken(document: String, password: String,completion: @escaping (Result<AuthResponse,NetworkError>) -> Void) {
        ...
        let endpoint = Endpoint(url: urlString,
                                ...
                                parameters: Parameters.dictionary(["cpf":document,"password":password]))
